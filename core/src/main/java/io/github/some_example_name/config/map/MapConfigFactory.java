...
public class MapConfigFactory {
    ...
    private static MapConfig createMap1Config() {
        ...
        wave1Dist.add(new EnemyDistribution(
            ...
            5, BASE_FAST_HEALTH, BASE_FAST_SPEED,                                      // Không có quái nhanh
            5, BASE_TANK_HEALTH, BASE_TANK_SPEED,                                      // Không có quái tank
            5, BASE_BOSS_HEALTH, BASE_BOSS_SPEED                                       // Không có boss
        ));
        // Đường 2: 3 quái thường
        wave1Dist.add(new EnemyDistribution(
            3, BASE_NORMAL_HEALTH, BASE_NORMAL_SPEED,     // Quái thường: 3 con, máu 100, tốc độ 100
            3, BASE_FAST_HEALTH, BASE_FAST_SPEED,                                      // Không có quái nhanh
            3, BASE_TANK_HEALTH, BASE_TANK_SPEED,                                      // Không có quái tank
            3, BASE_BOSS_HEALTH, BASE_BOSS_SPEED                                       // Không có boss
        ));
