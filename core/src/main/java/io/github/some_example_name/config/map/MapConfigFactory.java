...
public class MapConfigFactory {
    ...
    private static final float BASE_BOSS_HEALTH = 500;    // Máu cơ bản của boss
    private static final float BASE_BOSS_SPEED = 80;      // Tốc độ cơ bản của boss
    ...
    private static MapConfig createMap1Config() {
        ...
        wave1Dist.add(new EnemyDistribution(
            7, BASE_NORMAL_HEALTH, BASE_NORMAL_SPEED,     // Quái thường: 3 con, máu 100, tốc độ 100
            0, 0, 0,                                      // Không có quái nhanh
            0, 0, 0,                                      // Không có quái tank
            0, 0, 0                                       // Không có boss
        ));
        ...
        wave2Dist.add(new EnemyDistribution(
            6, BASE_NORMAL_HEALTH * 1.2f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 20%
        ...
        wave2Dist.add(new EnemyDistribution(
            7, BASE_NORMAL_HEALTH * 1.2f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 20%
        ...
        wave3Dist.add(new EnemyDistribution(
            9, BASE_NORMAL_HEALTH * 1.4f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 40%
        ...
        wave3Dist.add(new EnemyDistribution(
            7, BASE_NORMAL_HEALTH * 1.4f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 40%
        ...
        wave4Dist.add(new EnemyDistribution(
            8, BASE_NORMAL_HEALTH * 1.6f, BASE_NORMAL_SPEED * 1.1f,  // Quái thường: máu +60%, tốc độ +10%
        ...
        wave4Dist.add(new EnemyDistribution(
            7, BASE_NORMAL_HEALTH * 1.6f, BASE_NORMAL_SPEED * 1.1f,  // Quái thường: máu +60%, tốc độ +10%
        ...
        // Đường 1: 6 quái thường, 5 quái nhanh, 3 quái tank, 1 boss
        wave5Dist.add(new EnemyDistribution(
            ...
            1, BASE_BOSS_HEALTH * 1.2f, BASE_BOSS_SPEED * 1.1f      // Boss: máu +20%, tốc độ +10%
        ));
        // Đường 2: 4 quái thường, 3 quái nhanh, 3 quái tank, 1 boss
        wave5Dist.add(new EnemyDistribution(
    ...
    private static MapConfig createMap3Config() {
        Currency.initialize(500);
        PlayerHealth.initialize();
        ...
        // Đường 1: 5 quái thường
        wave1Dist.add(new EnemyDistribution(
            7, BASE_NORMAL_HEALTH, BASE_NORMAL_SPEED,     // Quái thường: 5 con, máu 100, tốc độ 100
            0, 0, 0,                                      // Không có quái nhanh
            0, 0, 0,                                      // Không có quái tank
            0, 0, 0                                       // Không có boss
        ));
        ...
        // Đường 1: 4 quái thường, 2 quái nhanh
        wave2Dist.add(new EnemyDistribution(
            8, BASE_NORMAL_HEALTH * 1.2f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 20%
            2, BASE_FAST_HEALTH, BASE_FAST_SPEED,                 // Quái nhanh: thông số cơ bản
            0, 0, 0,                                              // Không có quái tank
            0, 0, 0                                               // Không có boss
        ));
        ...
        // Đường 2: 2 quái thường, 2 quái nhanh, 1 quái tank
        wave3Dist.add(new EnemyDistribution(
            5, BASE_NORMAL_HEALTH * 1.4f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 40%
            3, BASE_FAST_HEALTH * 1.2f, BASE_FAST_SPEED * 1.1f,  // Quái nhanh: máu +20%, tốc độ +10%
            1, BASE_TANK_HEALTH * 1.1f, BASE_TANK_SPEED,         // Quái tank: máu tăng 10%
            0, 0, 0                                               // Không có boss
        ));
        wave3.setEnemyDistributions(wave3Dist);
        ...
        // Đường 1: 6 quái thường, 5 quái nhanh, 3 quái tank, 1 boss
        wave5Dist.add(new EnemyDistribution(
            9, BASE_NORMAL_HEALTH * 1.8f, BASE_NORMAL_SPEED * 1.2f,  // Quái thường: máu +80%, tốc độ +20%
            5, BASE_FAST_HEALTH * 1.6f, BASE_FAST_SPEED * 1.2f,     // Quái nhanh: máu +60%, tốc độ +20%
            3, BASE_TANK_HEALTH * 1.5f, BASE_TANK_SPEED * 1.1f,     // Quái tank: máu +50%, tốc độ +10%
            2, BASE_BOSS_HEALTH * 1.2f, BASE_BOSS_SPEED * 1.1f      // Boss: máu +20%, tốc độ +10%
        ));
        // Đường 2: 4 quái thường, 3 quái nhanh, 3 quái tank, 1 boss
        wave5Dist.add(new EnemyDistribution(
            8, BASE_NORMAL_HEALTH * 1.8f, BASE_NORMAL_SPEED * 1.2f,  // Quái thường: máu +80%, tốc độ +20%
            3, BASE_FAST_HEALTH * 1.6f, BASE_FAST_SPEED * 1.3f,     // Quái nhanh: máu +60%, tốc độ +30%
            3, BASE_TANK_HEALTH * 1.5f, BASE_TANK_SPEED * 1.1f,     // Quái tank: máu +50%, tốc độ +10%
            2, BASE_BOSS_HEALTH * 1.2f, BASE_BOSS_SPEED * 1.1f      // Boss: máu +20%, tốc độ +10%
        ));
    ...
    private static MapConfig createMap2Config() {
        ...
        // Đường 1: 5 quái thường
        wave1Dist.add(new EnemyDistribution(
            9, BASE_NORMAL_HEALTH, BASE_NORMAL_SPEED,     // Quái thường: thông số cơ bản
            0, 0, 0,                                      // Không có quái nhanh
            0, 0, 0,                                      // Không có quái tank
            0, 0, 0                                       // Không có boss
        ));
        ...
        wave1Dist.add(new EnemyDistribution(
            10, BASE_NORMAL_HEALTH, BASE_NORMAL_SPEED,     // Quái thường: thông số cơ bản
            0, 0, 0,                                      // Không có quái nhanh
            0, 0, 0,                                      // Không có quái tank
            0, 0, 0                                       // Không có boss
        ));
        ...
        wave2Dist.add(new EnemyDistribution(
            9, BASE_NORMAL_HEALTH * 1.2f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 20%
        ...
        // Đường 1: 3 quái thường, 2 quái nhanh, 2 quái tank
        wave3Dist.add(new EnemyDistribution(
            6, BASE_NORMAL_HEALTH * 1.4f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 40%
            2, BASE_FAST_HEALTH * 1.2f, BASE_FAST_SPEED,         // Quái nhanh: máu tăng 20%
            2, BASE_TANK_HEALTH, BASE_TANK_SPEED,                 // Quái tank: thông số cơ bản
            0, 0, 0                                               // Không có boss
        ));
        ...
        // Đường 3: 2 quái thường, 2 quái nhanh
        wave3Dist.add(new EnemyDistribution(
            4, BASE_NORMAL_HEALTH * 1.4f, BASE_NORMAL_SPEED,      // Quái thường: máu tăng 40%
        ...
        wave5Dist.add(new EnemyDistribution(
            7, BASE_NORMAL_HEALTH * 1.8f, BASE_NORMAL_SPEED * 1.2f,  // Quái thường: máu +80%, tốc độ +20%
