...
//        Gdx.app.log("PlayerHealth", String.format("Initialized with %d max health", maxHealth));
    }
...
//        Gdx.app.log("PlayerHealth", String.format("Took %d damage from %s enemy. Health: %d -> %d",
//            damage, enemyType, oldHealth, currentHealth));
    }
...
//        Gdx.app.debug("PlayerHealth", String.format("Drawing health text '%s' at (%.1f, %.1f)",
//            healthText, textX, textY));
    }
